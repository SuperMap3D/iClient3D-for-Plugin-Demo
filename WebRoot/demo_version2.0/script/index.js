...
//		Ext.get('workspaceWindow').un({mouseleave:workspaceWindowMouseleave});
	...
	function initCallback()
	{
		...
		setTimeout(function(){
			var pos = [Ext.getBody().getWidth(),47];
			workspaceWindow.removeAll(false);
			workspaceWindow.setTitle('倾斜摄影');
			workspaceWindow.setWidth(80);
			workspaceWindow.animateTarget = 'osgb';
			workspaceWindow.add(Ext.getCmp('osgbPanel'));
			workspaceWindow.showAt(Ext.getBody().getWidth(),47);
			setFocus();
			tabpanelMask.hide();
		},2000);
